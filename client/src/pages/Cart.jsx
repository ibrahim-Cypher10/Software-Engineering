...
const Cart = () => {
    ...
    const handleRemoveProduct = (productId) => {
        fetch("http://localhost:3000/api/prodcart/removefromcart", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const handleAddProduct = (productId) => {
        fetch("http://localhost:3000/api/prodcart/addtocart", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const handleCheckout = () => {
        fetch("http://localhost:3000/api/orders/createordersdiffvendors", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
